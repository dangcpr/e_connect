...
class _AddCourseState extends State<AddCourse> {
  ...
  List<Step> stepList() => [
    Step(
      ...
      title: const Text('Tên khóa học', style: TextStyle(fontSize: 16),),
      content: Form(
        key: _formKey[0],
        child: Column(
          children: <Widget> [
    ...
    Step(
      ...
      title: Text('Thời gian khóa học', style: TextStyle(fontSize: 16),),
      content: Form(
        key: _formKey[1],
        child: Column(
          children: <Widget> [
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  onTap: () {
                    showDatePicker(
                      context: context, 
                      initialDate: _dateStart.text.isEmpty ? DateTime.now() : _dateStartTime , 
                      ...
                      setState(() {
                        _dateStartTime = date!;
                        _dateStart.text = DateFormat('dd/MM/yyyy').format(_dateStartTime!);
                      });
                    });
                  },
                  validator: (value) {
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  onTap: () {
                    showDatePicker(
                      context: context, 
                      initialDate: _dateEnd.text.isEmpty ? DateTime.now() : _dateEndTime , 
                      firstDate: DateTime.now(), 
                      lastDate: DateTime(DateTime.now().year + 30),
                      initialEntryMode: DatePickerEntryMode.calendarOnly,
                      builder: (context, child) {
                      ...
                      setState(() {
                        _dateEndTime = date!;
                        _dateEnd.text = DateFormat('dd/MM/yyyy').format(_dateEndTime!);
                      });
                    });
                  },
                  validator: (value) {
                    ...
                    if (_dateStartTime.isAtSameMomentAs(_dateEndTime) || _dateStartTime.isAfter(_dateEndTime)) {
    ...
    Step(
      ...
      title: Text('Bảo mật khóa học', style: TextStyle(fontSize: 16),),
      content: Form(
        key: _formKey[2],
        child: Column(
          children: <Widget> [
            ...
            Padding(
              ...
              child: SizedBox(
                width: 320,
                child: Text('Nếu nhập số 0 thì lớp học sẽ không bị giới hạn số lượng')
              )
            ),
